...
var rootAccountTableColumn = [
    { data: 'acct_id', title: 'Account ID' }, /* 1st column */
    { data: 'account_name', title: 'Account Name' }, /* 2nd column */
    { tmpl: Meteor.isClient && Template.rowCheckBox, title: 'Check to Select'}
  ];

TabularTables.rootAccount = new Tabular.Table({
    name: "BOAT Root Account",
    collection: RootAccount,
    "order": [[ 0, "asc" ]],
    columns: rootAccountTableColumn,
    "aLengthMenu": [[5, 10, 25, 100, 500], [5, 10, 25, 100, 500]],
    "iDisplayLength": 5, /* display all in single page. jQuery can only select the displayed items. */
    ...
    /* Use substring match and case-insensitive. smart: true means OR among entered words.  */
    search: {
      smart: false
    }
});
